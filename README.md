...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/young-star-8587
```

A live public deployment of this template is available at [https://young-star-8587.templates.workers.dev](https://young-star-8587.templates.workers.dev)
